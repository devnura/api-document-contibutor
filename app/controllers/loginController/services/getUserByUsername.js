const service = async (username, trx) => {
    ...
    let rows = await trx.withSchema('public')
        .first('t_m_user.i_id', 't_m_user.i_group', 't_m_group.n_group', 't_m_user.n_username', 't_m_user.e_password', 't_m_user.e_fullname', 't_m_user.e_email')
        .from('t_m_user')
